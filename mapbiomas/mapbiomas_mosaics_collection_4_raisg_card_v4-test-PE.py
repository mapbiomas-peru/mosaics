...
gridsAsset = 'projects/mapbiomas-raisg/COLECCION2/0_DATOS_AUXILIARES/VECTORES/cartas-raisg'

assetMasks = "projects/mapbiomas-workspace/AUXILIAR/landsat-mask"

csvFile = './data/C2Peru_ParametrosMosaicosL2 - prueba1.csv'
...
outputCollections = {
    'l4': 'projects/mapbiomas-raisg/MOSAICOS/mosaics-2-test-pe',
    'l5': 'projects/mapbiomas-raisg/MOSAICOS/mosaics-2-test-pe',
    'l7': 'projects/mapbiomas-raisg/MOSAICOS/mosaics-2-test-pe',
    'l8': 'projects/mapbiomas-raisg/MOSAICOS/mosaics-2-test-pe',
    'l9': 'projects/mapbiomas-raisg/MOSAICOS/mosaics-2-test-pe',
    'lx': 'projects/mapbiomas-raisg/MOSAICOS/mosaics-2-test-pe',
    'ly': 'projects/mapbiomas-raisg/MOSAICOS/mosaics-2-test-pe'
}
...
for row in table.itertuples():
    ...
    # if True:
        ...
        if outputName not in alreadyInCollection:
            ...
            mosaic = mosaic.set('version', str(row.VERSION))
